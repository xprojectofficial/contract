...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD79e0fC2756c49dD04c794664eBD83959F2D27ac;
...
contract XPRO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "XProject";
    ...
    uint256 private numTokensSellToAddToLiquidity = 30000000000 * 10**6 * 10**9;
